...
const Login = ({onLogin, onLogout}) => {
    ...
    return (
        <div className="bg-gray-100">
            {user ? (
                // Contenedor reducido para mostrar la barra de bienvenida y cerrar sesión
                ...
                <div className="flex min-h-screen">
                    {/* Parte izquierda: mensaje de inicio de sesión */}
                    ...
                    {/* Parte derecha: imagen de fondo de Unsplash */}
                    <div
